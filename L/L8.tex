...
\subsection{\S3. Systems of First-Order Equations, \(n\)-th Order Equations}

{\color{blue}\begin{definition}[System of First-Order ODEs]
...
\begin{remark}
The theory of continuation of solutions also applies to systems with minor changes in the proof. {\color{blue}The general form of a linear system is
\[\begin{cases}
...
\begin{itemize}
\item {\color{blue}For \(\frac{d\vec{y}}{dt} = A(t)\vec{y}\) (homogeneous):
\begin{itemize}
...
\end{itemize}}
\item {\color{blue}For \(\frac{d\vec{y}}{dt} = A(t)\vec{y} + \vec{b}(t)\) (\(\vec{b} \neq 0\), non-homogeneous):
\begin{itemize}
\item The general solution is:

...
{\color{blue}\[y_H(t) = c_1 y_1(t) + c_2 y_2(t) \ c_1, c_2 \in \mathbb{R}\]}
...
{\color{blue}\[\frac{d^2 y}{dt^2} - 2t \frac{dy}{dt} - 2y = 0\]}

Here, \(p(t)=1\), \(q(t)=-2t\), \(r(t)=-2\) (polynomials).

We'll look for solutions in the form
{\color{blue}\[y(t) = \sum_{n=0}^{\infty} a_n t^n \tag{32}\]}
...
\begin{align*}
\frac{dy}{dt} &= \sum_{n=1}^\infty n a_n t^{n-1} = \sum_{n=0}^\infty (n+1) a_n t^{n}\\
\frac{d^2 y}{dt^2} &= \sum_{n=2}^\infty n(n-1) a_n t^{n-2} = \sum_{n=0}^\infty n(n+1) a_{n+2} t^{n}
\end{align*}

\sout{Then, \(y(t)\) solves the eq. iff}
\begin{align*}
...
{\color{blue}If \(a_{n+2} = \frac{2 a_n}{n+2}\) for \(n \geq 0\) then \(y(t) = \sum_{n=0}^\infty a_n t^n\) solves the eq.}

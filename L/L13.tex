...
\begin{example}
    ...
    \(\frac{dy}{dt} - y = -2\) is in the form \(\frac{dy}{dt} + ay = b\) for \(a = -1\) and \(b = -2\).

    The eq. is linear with cont. coeff in \(\mathbb{R}\) (const. coeff.). Then the general solution is
    \begin{align*}
    ...
    Then the solution is \(y(t) = Ce^t + 2\) for \(t \in \mathbb{R}\).
\end{example}
...
\begin{recap}
    \begin{itemize}
        \item \(\frac{dy}{dt} = Ay\), where \(A \in \mathbb{R}^{n \times n}\).
        \item If \(A\) admits \(n\) real distinct eigenvalues \(\lambda_1, \cdots, \lambda_n\) with associated eigenvectors \(v_1, \cdots, v_n \in \mathbb{R}^n\), then \(\{ v_1 e^{\lambda_1 t}, \cdots, v_n e^{\lambda_n t} \}\) is a basis of solutions, \(t \in \mathbb{R}\).
        \item If \(A\) admits an eigenvalue \(\lambda = \alpha + i\beta\) where \(\beta \neq 0\), with eigenvector \(v = u + iw, \ u, w \in \mathbb{R}^n\), then
...
\[e^A = I + A + \frac{A^2}{2} + \frac{A^3}{3!} + \frac{A^4}{4!} + \cdots \ \text{where } A \in \mathbb{R}^{n \times n}\]
...
\begin{remark}
    \(F: I \subset \mathbb{R} \to \mathbb{R}^n, \ F = (f_1, \cdots, f_n), \ f_k: I \subset \mathbb{R} \to \mathbb{R}\) and \(\frac{dF}{dt} = \left( \frac{df_1}{dt}, \cdots, \frac{df_n}{dt} \right)\).
\end{remark}

Then, if \(v \in \mathbb{R}^n\) then \(y(t) = e^{At} v\) solves \(\frac{dy}{dt} = Ay\).
...
\begin{example}
    ...
    \begin{itemize}
        \item From \(\lambda_1 = 2\), we get the solution \(y^{(1)}(t) = v_1 e^{2t}\) where \(v_1\) is an eigenvector for \(\lambda_1\).
        \item From \(\lambda_2 = 1+i\) we get two solutions \(y^{(2)}(t) = e^{t}(u \cos t - w \sin t)\) and \(y^{(3)}(t) = e^{t}(u \sin t + w \cos t)\) in \(\mathbb{R}\), where \(v = u + iw\) is an eigenvector for \(\lambda_2\), \(u, w \in \mathbb{R}^5\).
        \item From \(\lambda_4 = 3\) we get the solutions \(y^{(4)}(t) = v_4 e^{3t}\), where \(v_4\) is an eigenvector for \(\lambda_4\), and \(y^{(5)}(t) = e^{At} \tilde{v}\), \(t \in \mathbb{R}\), where \(\tilde{v}\) is a solution to \((A-3I)^m \tilde{v} = 0\) for some \(m \in \mathbb{N}\), \(m \le 2\).
    \end{itemize}

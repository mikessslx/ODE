...
{\color{blue}\begin{theorem}[Picard-Lindelöf]
...
\begin{itemize}
\item {\color{blue}Step 1: Construction of a sequence \(\{y_n\}\)}
\item {\color{blue}Step 2: Convergence of \(\{y_n\}\) to \(y\)}
\item {\color{blue}Step 3: The limit function \(y\) is a solution}
\item {\color{blue}Step 4: The solution \(y\) is unique}
\end{itemize}

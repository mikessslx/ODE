...
{\color{blue}\[t^2 \frac{d^2 y}{dt^2} + \alpha t \frac{dy}{dt} + \beta y = 0 \ \alpha, \beta \in \mathbb{R}\]}
...
{\color{blue}So, \(r_1 = -\frac{1}{2}\left((\alpha-1) + \sqrt{(\alpha-1)^2 - 4\beta}\right)\) and \(r_2 = -\frac{1}{2}\left((\alpha-1) - \sqrt{(\alpha-1)^2 - 4\beta}\right)\).}

\begin{itemize}
\item {\color{blue}\((\alpha-1)^2 - 4\beta > 0\):
...
{\color{blue}Then, \(y_1(t) = t^\lambda \cos(\mu \ln t)\) and \(y_2(t) = t^\lambda \sin(\mu \ln t)\), \(t > 0\), are l.i. solutions (exercise).}
\end{itemize}
\end{example}
...
\leavevmode
\begin{enumerate}[a)]
\item {\color{blue}The Euler's eq. can be solved similarly for \(t < 0\) by introducing the change of variables \(s = -t\).}
...
\sout{For the case \(\frac{d^2 y}{dt^2} + p(t) \frac{dy}{dt} + q(t) y = 0\)
...
{\color{blue}We'll look for a solution in the form \(y(t) = \sum_{n=0}^{\infty} a_n t^{n+r}\).}
\end{remark}

\begin{theorem}
{\color{blue}Assume that \(t=0\) is a \textbf{regular singular point} to the equation (47). Assume that the expansions in (48) and (49) converge for \(|t| < \rho\). Let \(r_1\) and \(r_2\) be the solutions to \(r(r-1) + p_0 r + q_0 = 0\). Also, assume \(r_1 \ge r_2\) if \(r_1, r_2 \in \mathbb{R}\). Then the eq. (47) admits two l.i. solutions \(y_1\) and \(y_2\) in \((0, \rho)\) where

...
\subsection{§2. The Existence and Uniqueness Theorem for First-Order ODEs (Continued)}
...
\begin{example}
    ...
    Here, \(f(t, y) = 1 + y^2\). This IVP admits a solution given by \(y(t) = \tan(t)\) for \(t \in \left( -\frac{\pi}{2}, \frac{\pi}{2} \right)\). Notice that \(y\) cannot be extended outside this interval as a continuous function.
\end{example}
...
\begin{example}
    ...
    Here, \(f(t, y) = \sqrt{|y|}\). This problem has infinitely many solutions, for instance, those of the form
    \[y(t) = 
    \begin{cases} 
        0 & t \geq c \\
        \frac{(t - c)^2}{4} & t < c 

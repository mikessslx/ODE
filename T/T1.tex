...
\(\underbrace{\mu(t) (\frac{dy}{dt} + a(t)y)}_{\frac{d}{dt}(\mu(t) y)} = b(t) \mu(t)\), \(a, b\) are continuous functions in \(\mathbb{R}\).
...
\begin{proof}[Solution]
    ...
    \begin{align*}
        ...
        &= 2 + Ce^{-t^2/2}, \ C \in \mathbb{R}, \ t \in \mathbb{R}
    \end{align*}
    
    \(y(0) = 2 + C e^0 = 2 + C = 1 \iff C = -1\).
    
    So, \(y(t) = 2 - e^{-t^2/2}, \ t \in \mathbb{R}\).
\end{proof}

\subsection{Separable equations}

Given an ODE of first-order, \(\frac{dy}{dt} = f(t, y)\), we say that the equation is separable if it can be written as
...
\begin{proof}[Solution]
    ...
    \begin{align*}
        ...
        e^{y(t)} &= t^2/2 + C \\
        y(t) &= \ln\left( \frac{t^2}{2} + C \right)
    \end{align*}

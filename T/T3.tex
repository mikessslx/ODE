...
{\color{blue}The unique solution \(y(t)\) predicted by the theorem with \(a=b=1\) is defined in \([0, 1/2]\).}
\end{proof}
...
{\color{blue}Notice that \(\alpha = \min \left\{ a, \frac{b}{M} \right\}\) and \(M = \max_{-b \le y \le b} (1+y^2) = 1+b^2\). So, \(\alpha = \min \left\{ a, \frac{b}{1+b^2} \right\}\).}
\end{proof}
